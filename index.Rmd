...
**Breaking NEWS!** The registrar has scheduled our final exam for **Wednesday 14 December** from 1:30pm to 3:30. Plan your travel accordingly.
...
* Assignment 2 --- file `Topic-2.Rmd`
    ...
    - Theory 
        ...
        - ISL 3.7.3 and 3.7.4.
* Programming activities: [Sept 20](ProgrammingActivities/Day-03-Programming-Task.html), [Sept 22](ProgrammingActivities/Day-04-Programming-Task.html), [Sept 27](ProgrammingActivities/Day-05-Programming-Task.html)
...
* [Notes](Notes/classification.html)
