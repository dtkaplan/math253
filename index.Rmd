...
* Assignment 2 --- file `Topic-2.Rmd`
    ...
    - Theory 
        ...
        - ISL 3.7.3 and 3.7.4.
* Programming activities: [Feb 2](ProgrammingActivities/Day-04-Programming-Task.html), [Five](ProgrammingActivities/Day-05-Programming-Task.html), [Six](ProgrammingActivities/Day-06-Programming-Task.html)
