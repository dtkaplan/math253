...
* Assignment 2 --- file `Topic-2.Rmd`
    ...
    - Theory 
        ...
        - ISL 3.7.3 and 3.7.4.
* Programming activities: [Feb 2](ProgrammingActivities/Day-04-Programming-Task.html), [Feb 7](ProgrammingActivities/Day-05-Programming-Task.html), [Feb 14](ProgrammingActivities/Day-06-Programming-Task.html)
...
* Programming Activities: [Seven](ProgrammingActivities/Day-07-Programming-Task.html), [Eight](ProgrammingActivities/Day-08-Programming-Task.html), [Nine](ProgrammingActivities/Day-09-Programming-Task.html)
